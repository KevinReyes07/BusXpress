<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Buses.aspx.cs" Inherits="BusXpress.Buses" %>

<%--<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Buses.aspx.cs" Inherits="BusXpress.Driver" %>--%>
                    ...
                    <!--div class="col-xl-8 col-lg-8">
                        ...
                        <div class="col-xl-2 col-lg-2">
                            ...
                            <div class="header-btn">
                                <a href="/Mainpage.aspx"  class="btn btn1 d-none d-lg-block ">Return</a>
                        ...
                        <div class="col-xl-2 col-lg-2">
                            <!-- header-btn -->
                            <div class="header-btn">
                                <a href="/Welcome.aspx" class="btn btn1 d-none d-lg-block ">Log out</a>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        ...
                        <div class="single-room mb-50">
                            <div class="room-img">
                               <a href="/TravelOptions.aspx"><img src="images/autobus1-0.jpg" alt=""></a>
                            </div>
                            <div class="room-caption">
                                <h3><a href="/TravelOptions.aspx">BSX 1002-50</a></h3>
                                <div class="per-night">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6">
                       ...
                       <div class="single-room mb-50">
                            <div class="room-img">
                               <a href="/TravelOptions.aspx"><img src="images/autobus2-0.jpg" alt=""></a>
                            </div>
                            <div class="room-caption">
                                <h3><a href="/TravelOptions.aspx">BSX 631-503</a></h3>
                                <div class="per-night">
                                    <span><u></u><span> Capacity: 24 </span></span>
                                    <br />
                                    <br />
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6">
                      ...
                      <div class="single-room mb-50">
                            <div class="room-img">
                               <a href="/TravelOptions.aspx"><img src="images/autobus3-0.jpg" alt=""></a>
                            </div>
                            <div class="room-caption">
                                <h3><a href="/TravelOptions.aspx">BSX 464-20</a></h3>
                                <div class="per-night">
                                    <span><u></u><span> Capacity: 24 </span></span>
                                    <br />
                                    <br />
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6">
                       ...
                       <div class="single-room mb-50">
                            <div class="room-img">
                               <a href="/TravelOptions.aspx"><img src="images/autobus4-0.jpg" alt=""></a>
                            </div>
                            <div class="room-caption">
                                <h3><a href="/TravelOptions.aspx">BSX 512-9</a></h3>
                                <div class="per-night">
                                    <span><u></u><span> Capacity: 24 </span></span>
                                    <br />
                                    <br />
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6">
                       ...
                       <div class="single-room mb-50">
                            <div class="room-img">
                               <a href="/TravelOptions.aspx"><img src="images/autobus5-0.jpg" alt=""></a>
                            </div>
                            <div class="room-caption">
                                <h3><a href="/TravelOptions.aspx">BSX 405-24</a></h3>
                                <div class="per-night">
                                    <span><u></u><span> Capacity: 24 </span></span>
                                    <br />
                                    <br />
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6">
                       ...
                       <div class="single-room mb-50">
                            <div class="room-img">
                               <a href="/TravelOptions.aspx"><img src="images/autobus6-0.jpg" alt=""></a>
                            </div>
                            <div class="room-caption">
                                <h3><a href="/TravelOptions.aspx">BSX 503-54</a></h3>
                                <div class="per-night">
                                    <span><u></u><span> Capacity: 24 </span></span>
                                    <br />
                                    <br />
