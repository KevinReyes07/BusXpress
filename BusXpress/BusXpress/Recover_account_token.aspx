<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Recover_account_token.aspx.cs" Inherits="BusXpress.Recover_account_token" %>
        ...
        <div class="my-content">
            ...
            <br />
                                ...
                                <div class="form-group">
                                    <asp:TextBox ID="txttoken" runat="server" placeholder="Enter Token..." type="text" class="form-control" />
                                </div>

                                <asp:Button ID="token_Click" runat="server" Text="Verify" OnClick="token_Click_Click" />
