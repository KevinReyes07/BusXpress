    ...
    public partial class LogIn : System.Web.UI.Page
    {
        ...
        protected void ConfirmSession_Click(object sender, EventArgs e)
        {
            if (LoginPass.Text != "" && LoginUser.Text != "")
            {
                ...
                var cmd = "SELECT User_ID from users WHERE Username='" + user + "' AND Password='" + password + "';";
            ...
            //    var cmd2 = "SELECT User_ID from users WHERE Username='" + user + "' AND Password='" + password + "' AND Role ='Driver';";
